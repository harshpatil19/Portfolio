...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_8ed57vh', 'template_u0rvw49', formRef.current, 'qOT8aStsWoHjaLJLH')
      .then(
        (result) => {
            ...
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="w-full p-2">
                ...
                <textarea
                  ...
                  defaultValue={'Hello Harshwardhan,'}
                />
              </div>
              ...
              <a
                  href={`mailto:${contactEmail}?subject=Inquiry&body=Hello Harshwardhan`}
